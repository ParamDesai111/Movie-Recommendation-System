...
# from flask import Flask, request, render_template
# from recommendations_system.testingmodel1 import combine_data, create_model, get_recommendations, check_columns, process_plot_data, process_other_data
...
#         cosine_sim = create_model(combined_df)
#         recommendations = get_recommendations(movie_title.lower(), cosine_sim, combined_df)  # Ensure the title is lowercase
#     else:
#         recommendations = ["Please provide a valid movie title."]
#     return render_template('recommendations.html', recommendations=recommendations)
